...
# =============================================================================
# dpp.libs-basic.mk,v 1.15 2008/01/01 15:29:21 patrickh Exp
#
...
# advantage of this file by extending its logic and using the provided targets
...
#                  extensions.  If not specified, it defaults to "_p".
#
...
# $(LIBDIR) is the first-level subdirectory of $(LIBDIR_BASE).
LIBDIR?=	$(LIBDIR_BASE)

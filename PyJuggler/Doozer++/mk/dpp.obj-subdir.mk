...
# Date modified: 2002/04/19 18:41:10
# Version:       1.15.2.1
# -----------------------------------------------------------------
# *************** <auto-copyright.pl END do not edit this line> ***************

# =============================================================================
# dpp.obj-subdir.mk,v 1.15.2.1 2002/04/19 18:41:10 patrickh Exp
#
...
# Define $(_LOCAL_IDL) and $(_LOCAL_JIDL) to inform the shared 'cxx_idl' and
# 'java_idl' targets that there are local '_cxx_idl' targets to be run
# (respectively) besides the standard targets.
_LOCAL_CXX_IDL=		1
_LOCAL_JAVA_IDL=	1

_cxx_idl:
	@$(MAKE) RECTARGET="cxx_idl" recursive

_java_idl:
	@$(MAKE) RECTARGET="java_idl" recursive

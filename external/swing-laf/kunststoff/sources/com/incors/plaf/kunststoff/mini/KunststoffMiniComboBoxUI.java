 ...
 */
public class KunststoffMiniComboBoxUI extends MetalComboBoxUI
{

   public static ComponentUI createUI(JComponent c)
   {
      return new KunststoffMiniComboBoxUI();
   }
   ...
   {
      JButton button =
         new MyMetalComboBoxButton(comboBox, new MetalComboBoxIcon(),
                                   comboBox.isEditable(),

...
public class KunststoffMiniInternalFrameUI extends MetalInternalFrameUI
{
   ...
   public KunststoffMiniInternalFrameUI(JInternalFrame b)
   {
      super(b);
   }
   ...
   {
      return new KunststoffMiniInternalFrameUI((JInternalFrame)c);
   }
   ...
   protected JComponent createNorthPane(JInternalFrame w)
   {
      ...
      titlePane = new KunststoffMiniInternalFrameTitlePane(w);
      return titlePane;
   }

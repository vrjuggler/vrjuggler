...
public class KunststoffMiniListUI extends BasicListUI
{
   private boolean isToolkitTrueColor = false;
   private Color colBg;

   public KunststoffMiniListUI(JComponent list)
   {
   ...
   {
      return new KunststoffMiniListUI(list);
   }
   ...
   public void update(Graphics g, JComponent c)
   {
      if (c.isOpaque())
      {
         ...
         int shadow = KunststoffMiniLookAndFeel.getBackgroundGradientShadow();

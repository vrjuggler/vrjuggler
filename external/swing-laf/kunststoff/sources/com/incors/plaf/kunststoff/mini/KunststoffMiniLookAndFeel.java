 ...
 *
 */
public class KunststoffMiniLookAndFeel extends MetalLookAndFeel
{
   ...
   public KunststoffMiniLookAndFeel()
   {
      ...
      if (!isInstalled)
      {
         UIManager.installLookAndFeel("Kunststoff Mini",
                                      "com.incors.plaf.kunststoff.mini.KunststoffMiniLookAndFeel");
         isInstalled = true;
      }
   }
...
/*
      ...
      try
      {
         String className = "com.incors.plaf.kunststoff.mini.KunststoffMiniCheckBoxIcon";
...
*/
   ...
   protected void putDefault(UIDefaults table, String uiKey)
   {
      try
      {
         String className = "com.incors.plaf.kunststoff.mini.KunststoffMini" + uiKey;
   ...
   protected void createDefaultTheme()
   {
      if (!themeHasBeenSet)
      {
         setCurrentTheme(new KunststoffPalmtopTheme());
      }
   ...
   protected void initComponentDefaults(UIDefaults table)
   {
      ...
      table.put("SplitPane.dividerSize", new Integer(3)); // will result in only one row of bumps
   }

...
public class ConfigCommunicator
    ...
    public ConfigCommunicator () {
        super();
        component_name = "Unconfigured ConfigCommunicator";
        nc = null;
        outstream = null;
        config_module = null;
        active_chunkdb = null;
...
//      }
    ...
    throws IOException {
        if (!connected) {
            Core.consoleErrorMessage ("Net", "ConfigCommunicator.readStream called without connection.");
            return false;
        }
	...
	if (!connected) {
            Core.consoleErrorMessage ("Net", "ConfigCommunicator send command requested, but no connection.");
	    return false;
        }

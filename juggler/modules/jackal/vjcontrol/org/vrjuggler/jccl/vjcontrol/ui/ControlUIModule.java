...
public class ControlUIModule
   extends JFrame
   implements ActionListener, WindowListener, LogMessageListener,
              ChunkDBListener, CoreModule
{
   ...
   public VjComponent addConfig (ConfigChunk ch) throws VjComponentException {
      ...
      if( Core.component_factory.classSupportsInterface (classname, PlugPanel.class) )
      {
      ...
      else if( Core.component_factory.classSupportsInterface (classname, PlugPanelContainer.class) )
      {
...
//             }
   ...
   protected void reconfigure (ConfigChunk ch)
   {
      ...
      {
         looknfeel =
            ch.getProperty(VjComponentTokens.LOOKNFEEL, 0).getString();
         fontsize =
            ch.getProperty(VjComponentTokens.FONT_SIZE, 0).getInt();
         fontname =
            ch.getProperty(VjComponentTokens.FONT_NAME, 0).getString();
      }
      catch( Exception e )
      {

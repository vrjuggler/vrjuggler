...
#include <IO/Port/SerialPortFactory.h>
...
public:
    ...
    SerialPort (const std::string& port_name)
        : Port(port_name), m_sio_imp(NULL)
    {
        SerialPortFactory fac;
    ...
    // ------------------------------------------------------------------------
    // ------------------------------------------------------------------------
    inline virtual SerialTypes::UpdateActionOption
...
protected:
    SerialPortImp* m_sio_imp;    //: Platform-specific serial port

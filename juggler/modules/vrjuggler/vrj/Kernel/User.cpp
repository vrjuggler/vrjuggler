...
bool vjUser::config(vjConfigChunk* chunk)
{
   ...
   vjDEBUG_BEGIN(vjDBG_ALL,1) << "vjUser::config: Creating a new user\n" << vjDEBUG_FLUSH;
   ...
   vjDEBUG(vjDBG_ALL,1) << "id: " << mUserId << "   Name:" << mName << "   headPos:" << head_alias << endl << vjDEBUG_FLUSH;
   vjDEBUG_END(vjDBG_ALL,1) << "\n" << vjDEBUG_FLUSH;
   return true;
}

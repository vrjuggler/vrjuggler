...
namespace vrj
{
   ...
   bool ajSoundManager::configAdd( jccl::ConfigChunkPtr chunk )
   {
   ...
   //! PRE: configCanHandle(chunk) == true
   bool ajSoundManager::configRemove(jccl::ConfigChunkPtr chunk)
   {
   ...
   bool ajSoundManager::configCanHandle( jccl::ConfigChunkPtr chunk )
   {

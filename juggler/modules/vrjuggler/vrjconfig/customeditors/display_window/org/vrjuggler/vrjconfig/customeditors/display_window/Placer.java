   ...
   extends JPanel
{
   ...
   /**
    * Sets the surface viewport renderer to use with this placer.
    */
   ...
   /**
    * Gets the viewport renderer used with this placer.
    */
   ...
   public synchronized void paint(Graphics g)
   {
      ...
      for (int i=getModel().getSize()-1; i>=0; --i)
      {
         Component rendererComponent =
            renderer.getPlacerRendererComponent(this, getModel().getElement(i),

 ...
 */
public class CurrentDevicesStep
   ...
   implements WizardPane
{
   ...
   */
   ...
   public void onEntering()
   {
      ...
      if (cwp == null)
      {
         cwp = new CurrentDevicesPanel();
      }
      cwp.init(mWhiteBoard);
      mBroker.addConfigListener(cwp);
   }
   ...
   public void onExited()
   {
      ...
      mBroker.removeConfigListener(cwp);
      //return(cwp.loadFile());
   }
   /**
   ...
   */
    ...
    */
   private transient CurrentDevicesPanel cwp = null;
   private transient ConfigBroker mBroker = null;
}

...
public class ChunkDescFrame 
    ...
    public ChunkDescFrame (ClientGlobals c, 
			   ChunkDescDBPanel p, 
			   ChunkDesc d,
			   boolean _editable) {
	...
	northpanel.add (new Label ("ChunkDesc Token:", 
				   Label.RIGHT));
	...
	g.draw3DRect(3, 3, getSize().width-6, 
		     getSize().height-6, true);
	g.draw3DRect(2, 2, getSize().width-4, 
		     getSize().height-4, false);
    }

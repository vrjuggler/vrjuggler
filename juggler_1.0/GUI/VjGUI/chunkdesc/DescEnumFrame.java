...
public class DescEnumFrame extends JFrame 
  ...
  public DescEnumFrame (PropertyDescPanel p,
    ...
    JScrollPane sp = new JScrollPane(sppanel, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);

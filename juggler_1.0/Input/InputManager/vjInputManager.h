...
public:
   ...
   */
   ...
   //: Get the positional data at positional Proxy d
   //
   //!POST: return = pointer to vjPOS_DATA structure,
   //!POST:        guaranteed to be valid until the next UpdateData
   vjMatrix* GetPosData(int d);

   //: Get positional data
   void GetPosData(vjMatrix& posData, int index);

   /** @name Digital Proxy Level

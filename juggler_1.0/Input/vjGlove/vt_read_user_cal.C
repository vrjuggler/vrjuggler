...
int
vjCyberGlove::vt_geom_in(FILE *inputfp, UserGeometry user)
{
...
void
vjCyberGlove::vt_geom_out( FILE *outputfp, UserGeometry user)
{
  int i, finger, joint;
...
int
vjCyberGlove::vt_read_glove_calibration(FILE *inputfp, CbGlove glove)
{
...
void
vjCyberGlove::vt_write_glove_calibration(FILE *outputfp, CbGlove glove,
			   char *version_string)
{
  int finger,joint;
...
int
vjCyberGlove::vt_hand_read(VirtualHand hand, char *filename)
{
  int success;
  FILE *inputfp;
...
int
vjCyberGlove::vt_hand_write(VirtualHand hand, char *filename, char *version_string)
{
  FILE *outputfp;

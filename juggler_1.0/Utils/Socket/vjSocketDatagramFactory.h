...
#ifdef WIN32
#include <Utils/Socket/vjSocketDatagramImpWinSock.h>
#else
...
#else
        return new vjSocketDatagramImpUNIX();
#endif
    }
...
#else
        return new vjSocketDatagramImpUNIX(address, port, domain);
#endif
    }
};

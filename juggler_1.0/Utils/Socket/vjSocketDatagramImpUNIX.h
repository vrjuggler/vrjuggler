...
#ifndef _VJ_SOCKET_DATAGRAM_IMP_UNIX_H_
#define _VJ_SOCKET_DATAGRAM_IMP_UNIX_H_

#include <string>

#include <Utils/Socket/vjSocketDatagramImp.h>
#include <Utils/Socket/vjSocketImpUNIX.h>


class vjSocketDatagramImpUNIX : virtual public vjSocketImpUNIX,
...
public:
    ...
    // ------------------------------------------------------------------------
    vjSocketDatagramImpUNIX(const std::string& address,
    ...
    //! POST: None.
    // ------------------------------------------------------------------------
    virtual ~vjSocketDatagramImpUNIX(void);
...
#endif	/* _VJ_SOCKET_DATAGRAM_IMP_UNIX_H_ */

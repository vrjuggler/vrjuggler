...
#ifndef _VJ_SOCKET_STREAM_IMP_UNIX_H_
#define _VJ_SOCKET_STREAM_IMP_UNIX_H_

#include <string>

#include <Utils/Socket/vjSocketStreamImp.h>
#include <Utils/Socket/vjSocketImpUNIX.h>


class vjSocketStreamImpUNIX : virtual public vjSocketImpUNIX,
                              virtual public vjSocketStreamImp
{
public:
    // ========================================================================
    ...
    // ------------------------------------------------------------------------
    vjSocketStreamImpUNIX(const std::string& address,
    ...
    // POST: None.
    // ------------------------------------------------------------------------
    virtual ~vjSocketStreamImpUNIX(void);
...
protected:
    ...
    //                 connected.
    // ------------------------------------------------------------------------
    vjSocketStreamImpUNIX(const int sock, vjInetAddr& host_addr);
};


#endif	/* _VJ_SOCKET_STREAM_IMP_UNIX_H_ */

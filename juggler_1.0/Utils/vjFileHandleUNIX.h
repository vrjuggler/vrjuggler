...
#ifndef _VJ_FILE_HANDLE_UNIX_H_
#define _VJ_FILE_HANDLE_UNIX_H_

#include <sys/types.h>
#include <string>
#include <vector>

#include <Utils/vjFileHandle.h>


class vjFileHandleUNIX : public vjFileHandle {
public:
    // ------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------------------
    vjFileHandleUNIX(const std::string& file_name);
    ...
    // ------------------------------------------------------------------------
    virtual ~vjFileHandleUNIX(void);

    // ========================================================================
    // vjBlockIO implementation.
    // ========================================================================
    ...
    //+                where the file contents are to be stored.
    //! ARGS: length - The number of bytes to be read.
    //
    //! RETURNS: >-1 - The number of bytes successfully read from the file
    //+                handle.
    //! RETURNS:  -1 - An error occurred when reading.
    // ------------------------------------------------------------------------
    virtual ssize_t read(unsigned char* buffer, const size_t length);
    ...
    //! RETURNS:  -1 - An error occurred when reading.
    // ------------------------------------------------------------------------
    virtual ssize_t read(char* buffer, const size_t length);
    ...
    //! RETURNS:  -1 - An error occurred when reading.
    // ------------------------------------------------------------------------
    virtual ssize_t readn(unsigned char* buffer, const size_t length);
    ...
    //! RETURNS:  -1 - An error occurred when reading.
    // ------------------------------------------------------------------------
    virtual ssize_t readn(char* buffer, const size_t length);
...
protected:
    // Friends.
    friend class vjSerialPortImpTermios;
    friend class vjSocketDatagramImpUNIX;
    friend class vjSocketImpUNIX;
    friend class vjSocketStreamImpUNIX;

...
#   include <VPR/SharedMem/vjMemPoolHeap.h>  // Everything is heap!!!
...
#   include <VPR/SharedMem/vjMemPoolHeap.h>
    ...
    typedef vjMemPoolPosix vjSharedPool;
    typedef vjMemPoolHeap  vjHeapPool;
    typedef vjMemPoolPosix vjSyncPool;
#else
#   include <VPR/md/NSPR/vjMemPoolNSPR.h>
#   include <VPR/SharedMem/vjMemPoolHeap.h>

    typedef vjMemPoolNSPR vjSharedPool;
    typedef vjMemPoolHeap vjHeapPool;
    typedef vjMemPoolNSPR vjSyncPool;
#endif	/* VJ_IRIX_SPROC */

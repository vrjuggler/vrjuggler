...
#ifndef _VJ_RW_MUTEX_NSPR_H_
#define _VJ_RW_MUTEX_NSPR_H_
...
{
public:
    vjRWMutexNSPR (void) : m_rw_lock(NULL) {
...
protected:
    ...
    void operator= (const vjRWMutexNSPR &) {}
    vjRWMutexNSPR (const vjRWMutexNSPR &) {}
};


#endif	/* _VJ_RW_MUTEX_H_ */

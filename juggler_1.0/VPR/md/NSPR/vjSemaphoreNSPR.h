...
#ifndef _VJ_SEMAPHORE_NSPR_H_
#define _VJ_SEMAPHORE_NSPR_H_
...
//!PUBLIC_API:
class vjSemaphoreNSPR {
public:
    // -----------------------------------------------------------------------
    //: Custructor for vjSemaphoreNSPR class.
    //
    //! PRE: None.
...
protected:
    vjCond*     mCondVar;       //: Semaphore simulator variable for the class
    PRInt32     mValue;

    // Prevent assignment and initialization.
    void operator= (const vjSemaphoreNSPR &) {
        /* Do nothing. */ ;
    }

    vjSemaphoreNSPR (const vjSemaphoreNSPR &) {
        /* Do nothing. */ ;
    }
};


#endif  /* _VJ_SEMAPHORE_NSPR_H_ */

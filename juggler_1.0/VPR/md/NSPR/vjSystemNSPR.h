 ...
 * --------------------------------------------------------------------------
 * NOTES:
 *    - This file (vjSystemNSPR.h) MUST be included by vjSystem.h, not the
 *      other way around.
 * --------------------------------------------------------------------------
 */

#ifndef _VJ_SYSTEM_NSPR_H_
#define _VJ_SYSTEM_NSPR_H_
...
class vjSystemNSPR: public vjSystemBase {
public:
    inline static int

...
#ifndef _VJ_MEM_POOL_POSIX_H_
#define _VJ_MEM_POOL_POSIX_H_
...
class vjMemPoolPosix : public vjMemPool {
public:
    // -----------------------------------------------------------------------
    //: Constructor for vjMemPoolPosix class.
    //
    //! PRE: None.
    //! POST: None (for now).
    //
    ...
    // -----------------------------------------------------------------------
    //: Destructor for vjMemPoolPosix class.
    //
    //! PRE: None.
    //! POST: None (for now).
    // -----------------------------------------------------------------------
    ...
    allocate (size_t size) {
        ...
        if ( retval == NULL ) {
            std::cerr << "vjMemPoolPosix: Out of memory!!!\n";
        }

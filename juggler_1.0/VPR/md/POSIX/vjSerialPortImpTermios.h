...
#ifndef _VJ_SERIAL_PORT_IMP_TERMIOS_H_
#define _VJ_SERIAL_PORT_IMP_TERMIOS_H_

#include <termios.h>
#include <string>
#include <vector>

#include <VPR/IO/Port/vjSerialPortImp.h>
#include <VPR/md/POSIX/vjFileHandleUNIX.h>
#include <VPR/IO/Port/vjSerialTypes.h>


// ----------------------------------------------------------------------------
//: vjSerialPort implementation using termios.
// ----------------------------------------------------------------------------
class vjSerialPortImpTermios : public vjSerialPortImp {
public:
    // ------------------------------------------------------------------------
    ...
    //+       action is set to vjSerialTypes::NOW.
    //
    //! ARGS: port_name - The name of the serial port that will be accessed.
    // ------------------------------------------------------------------------
    vjSerialPortImpTermios(const std::string& port_name);
    ...
    // ------------------------------------------------------------------------
    virtual ~vjSerialPortImpTermios(void);
    ...
    // ========================================================================
    // vjSerialPortImp interface implementation.
    // ========================================================================

    // ------------------------------------------------------------------------
    // ------------------------------------------------------------------------
    virtual vjSerialTypes::UpdateActionOption getUpdateAction(void);

    // ------------------------------------------------------------------------
    // ------------------------------------------------------------------------
    virtual void setUpdateAction(vjSerialTypes::UpdateActionOption action);
    ...
    // ------------------------------------------------------------------------
    // ------------------------------------------------------------------------
    virtual int controlFlow(vjSerialTypes::FlowActionOption opt);

    // ------------------------------------------------------------------------
    // ------------------------------------------------------------------------
    virtual int flushQueue(vjSerialTypes::FlushQueueOption opt);
...
protected:
    ...
    vjFileHandleUNIX*	m_handle;    //: File handle for the serial port
    int			m_actions;
};


#endif	/* _VJ_SERIAL_PORT_IMP_TERMIOS_H_ */

...
// ----------------------------------------------------------------------------
vjSocketDatagramImpBSD::vjSocketDatagramImpBSD (void)
    : vjSocketImpBSD(), vjSocketDatagramImp()
{
fprintf(stderr, "vjSocketDatagramImpBSD default constructor\n");
    /* Do nothing. */ ;
}
...
// ----------------------------------------------------------------------------
vjSocketDatagramImpBSD::vjSocketDatagramImpBSD (const std::string& address,
                                                  const unsigned short port,
                                                  const vjSocketTypes::Domain domain)
    : vjSocketImpBSD(address, port, domain, vjSocketTypes::DATAGRAM),
...
fprintf(stderr, "vjSocketDatagramImpBSD(address, port, domain) constructor\n");
...
// ----------------------------------------------------------------------------
vjSocketDatagramImpBSD::~vjSocketDatagramImpBSD () {
    /* Do nothing. */ ;
}
...
// ----------------------------------------------------------------------------
ssize_t
vjSocketDatagramImpBSD::recvfrom (void* msg, const size_t len,
                                   const int flags, vjInetAddr& from)
{
    ...
    if ( bytes == -1 ) {
        fprintf(stderr,
                "[vjSocketDatagramImpBSD] ERROR: Could not read from socket (%s:%hu): %s\n",
...
// ----------------------------------------------------------------------------
ssize_t
vjSocketDatagramImpBSD::recvfrom (unsigned char* msg, const size_t len,
                                   const int flags, vjInetAddr& from)
{
...
// ----------------------------------------------------------------------------
ssize_t
vjSocketDatagramImpBSD::recvfrom (char* msg, const size_t len,
                                   const int flags, vjInetAddr& from)
{
    return recvfrom((void*) msg, len, flags, from);
}
...
// ----------------------------------------------------------------------------
ssize_t
vjSocketDatagramImpBSD::recvfrom (std::vector<char>& msg, const int flags,
                                   vjInetAddr& from)
{
...
// ----------------------------------------------------------------------------
ssize_t
vjSocketDatagramImpBSD::recvfrom (std::vector<char>& msg, const size_t len,
                                   const int flags, vjInetAddr& from)
{
    ssize_t bytes;
    char* temp_buf;
...
// ----------------------------------------------------------------------------
ssize_t
vjSocketDatagramImpBSD::sendto (const void* msg, const size_t len,
                                const int flags, const vjInetAddr& to)
{
    ...
    if ( bytes == -1 ) {
        fprintf(stderr,
                "[vjSocketDatagramImpBSD] ERROR: Could not send to %s:%hu on socket (%s:%hu): %s\n",
...
// ----------------------------------------------------------------------------
ssize_t
vjSocketDatagramImpBSD::sendto (const unsigned char* msg, const size_t len,
                                const int flags, const vjInetAddr& to)
{
...
// ----------------------------------------------------------------------------
ssize_t
vjSocketDatagramImpBSD::sendto (const char* msg, const size_t len,
                                const int flags, const vjInetAddr& to)
{
    return sendto((void*) msg, len, flags, to);
}
...
// ----------------------------------------------------------------------------
ssize_t
vjSocketDatagramImpBSD::sendto (const std::vector<char>& msg,
                                const int flags, const vjInetAddr& to)
{

...
#ifndef _VJ_SOCKET_DATAGRAM_IMP_BSD_H_
#define _VJ_SOCKET_DATAGRAM_IMP_BSD_H_
...
class vjSocketDatagramImpBSD : virtual public vjSocketImpBSD,
...
public:
    ...
    // ------------------------------------------------------------------------
    vjSocketDatagramImpBSD(const std::string& address,
    ...
    //! POST: None.
    // ------------------------------------------------------------------------
    virtual ~vjSocketDatagramImpBSD(void);
...
#endif	/* _VJ_SOCKET_DATAGRAM_IMP_BSD_H_ */

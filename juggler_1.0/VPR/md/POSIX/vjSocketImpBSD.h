...
#ifndef _VJ_SOCKET_IMP_BSD_H_
#define _VJ_SOCKET_IMP_BSD_H_
...
class vjSocketImpBSD : virtual public vjSocketImp {
public:
    // ========================================================================
    // vjBlockIO overrides.
    // ========================================================================
...
protected:
    ...
    //     address string.
    // ------------------------------------------------------------------------
    vjSocketImpBSD(const std::string& address, const unsigned short port,

...
#ifndef _VJ_SOCKET_STREAM_IMP_BSD_H_
#define _VJ_SOCKET_STREAM_IMP_BSD_H_
...
class vjSocketStreamImpBSD : virtual public vjSocketImpBSD,
...
public:
    ...
    // ------------------------------------------------------------------------
    vjSocketStreamImpBSD(const std::string& address, const unsigned short port);
    ...
    // POST: None.
    // ------------------------------------------------------------------------
    virtual ~vjSocketStreamImpBSD(void);
...
protected:
    ...
    //                 connected.
    // ------------------------------------------------------------------------
    vjSocketStreamImpBSD(const int sock, vjInetAddr& host_addr);
};

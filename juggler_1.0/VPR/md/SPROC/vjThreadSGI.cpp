...
vjThreadSGI::vjThreadSGI (vj_thread_func_t func, void* arg,
                          vjBaseThread::VJThreadPriority priority,
                          vjBaseThread::VJThreadScope scope,
                          vjBaseThread::VJThreadState state,
                          size_t stack_size)
{
...
vjThreadSGI::vjThreadSGI (vjBaseThreadFunctor* functorPtr,
                          vjBaseThread::VJThreadPriority priority,
                          vjBaseThread::VJThreadScope scope,
                          vjBaseThread::VJThreadState state, size_t stack_size)
{
    mUserThreadFunctor = NULL;

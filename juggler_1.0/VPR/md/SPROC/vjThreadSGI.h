...
public:
   ...
   //  function.
   // -----------------------------------------------------------------------
   vjThreadSGI(vj_thread_func_t func, void* arg = 0,
               vjBaseThread::VJThreadPriority priority = VJ_PRIORITY_NORMAL,
               vjBaseThread::VJThreadScope scope = VJ_LOCAL_THREAD,
               vjBaseThread::VJThreadState state = VJ_JOINABLE_THREAD,
               size_t stack_size = 0);
   ...
   //  function.
   // -----------------------------------------------------------------------
   vjThreadSGI(vjBaseThreadFunctor* functorPtr,
               vjBaseThread::VJThreadPriority priority = VJ_PRIORITY_NORMAL,
               vjBaseThread::VJThreadScope scope = VJ_LOCAL_THREAD,
               vjBaseThread::VJThreadState state = VJ_JOINABLE_THREAD,
               size_t stack_size = 0);
   ...
   // -----------------------------------------------------------------------
   virtual int
   spawn (vjBaseThreadFunctor* functorPtr,
          vjBaseThread::VJThreadPriority priority = VJ_PRIORITY_NORMAL,
          vjBaseThread::VJThreadScope scope = VJ_LOCAL_THREAD,
          vjBaseThread::VJThreadState state = VJ_JOINABLE_THREAD,
          size_t stack_size = 0)

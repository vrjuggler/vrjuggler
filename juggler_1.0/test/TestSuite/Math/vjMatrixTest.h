...
class vjMatrixTest : public TestCase
{
public:
   vjMatrixTest( std::string name ) : TestCase (name), 
   ...
   static Test* suite()
   {
      ...
      testSuite->addTest( new TestCaller<vjMatrixTest>( "setmatrix", setmatrix ));
      return testSuite;
   }

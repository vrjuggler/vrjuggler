...
[
    ...
    DPP_CHECK_CC_FALLBACKS([$CC], , [AC_MSG_ERROR($CC_ERR)])
    DPP_PROG_CC
    DPP_CHECK_CXX_FALLBACKS([$CXX], , [AC_MSG_ERROR($CXX_ERR)])
    DPP_PROG_CXX
    DPP_SETUP_COMPILER
    DPP_GET_EXT
...
[
    ...
    APP_CFLAGS="$2"
    APP_CXXFLAGS="$4"
    APP_DEBUG_CFLAGS="$5 -DJUGGLER_DEBUG"
    APP_OPTIM_CFLAGS="$6 -DJUGGLER_OPT -DNDEBUG"
    APP_DEFS="$8"

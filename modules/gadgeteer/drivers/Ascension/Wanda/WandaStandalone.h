...
public:
    ...
    *
    * @throw wanda::IOException is thrown if there is a problem communciating
...
private:
    ...
    * wanda::TimeoutException is thrown.
    *
    ...
    *
    * @throw wanda::TimeoutException is thrown if the read operation could not

...
#ifndef _SDL_RUMBLE_EFFECT_CONSTANT_H_
#define _SDL_RUMBLE_EFFECT_CONSTANT_H_

#include "SdlRumbleEffect.h"

#if SDL_VERSION_ATLEAST(1,3,0)

class SdlRumbleEffectConstant
   : public SdlRumbleEffect
{
public:
   SdlRumbleEffectConstant(SDL_Haptic *haptic);
   virtual ~SdlRumbleEffectConstant();

...
public:
   ...
   /**
    * Sets the number of birds connected to the MotionStar.
    *
    * @pre None.
    * @post The number of birds is updated to the new value.
    *
    * @param numBirds The new value for the number of birds in use.
    */
   void setNumBirds(const unsigned int numBirds)
   {
      m_birds_requested = numBirds;
   }

   /**
    * Gets the number of bird currently connected to the MotionStar.
    *
    * @pre None.
    ...
    */
   const unsigned int& getNumBirds() const
   {
   ...
   /**
    * Gets the y position of the i'th bird.  This is only valid if the bird
    * in question is generating positional data.
    *
    * @pre The given bird index is in the vector of defined devices.
   ...
   /**
    * Gets the z position of the i'th bird.  This is only valid if the bird
    * in question is generating positional data.
    *
    * @pre The given bird index is in the vector of defined devices.
   ...
   /**
    * Gets the z rotation of the i'th bird.  This is only valid if the bird
   ...
   /**
    * Gets the y rotation of the i'th bird.  This is only valid if the bird
    * in question is generating angular data.
    *
    * @pre The given bird index is in the vector of defined devices.
   ...
   /**
    * Gets the x rotation of the i'th bird.  This is only valid if the bird
    * in question is generating angular data.
    *
    * @pre The given bird index is in the vector of defined devices.
   ...
   /**
    * Gets the rotation angles of the requested bird as matrix elements that
   ...
   /**
    * Gets the rotation angles of the requested bird as quaternion parameters

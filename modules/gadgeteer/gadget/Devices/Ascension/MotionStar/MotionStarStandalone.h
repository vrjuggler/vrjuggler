...
struct HEADER
{
    ...
    *        initialized.
    *
    * @param msg_type  The type of message being constructed.
    */
...
public:
    ...
    * @param bird_format       The bird data format.
    * @param run_mode          The data request mode for the server.
    * @param report_rate       The rate at which data is generated by the
    *                           birds relative to the sample rate (0-255).
    * @param measurement_rate 
    * @param birds_requested   The number of birds whose data will be
    *                           sampled.
    */
    ...
    * @post
    *
    * @return NULL - No address has been set.
    * @return Non-NULL - A character array naming the server address.
    */
    ...
    *
    * @param master  The new value for the master status of this server
    *                 chassis.
    */
    ...
    *
    * @param num_birds  The new value for the number of birds in use.
    */
    ...
    *        caller.
    *
    * @param i  The zero-based index of the FBB device whose current x
    ...
    *        caller.
    *
    * @param i  The zero-based index of the FBB device whose current y
    *            position is to be returned.
    *
    ...
    *        caller.
    *
    * @param i  The zero-based index of the FBB device whose current z
    *            position is to be returned.
    *
    ...
    *        angles array.
    *
    * @param bird    The zero-based index of the FBB device whose current
    *                 rotation is to be returned.
    ...
    *        quat array.
    *
    * @param bird  The zero-based index of the FBB device whose quaternion
...
private:
    ...
    *
    * @return  0 - The server was awakened.
    * @return -1 - The server could not be awakened for some reason.
    */
    ...
    *
    * @param sys_status  The current system status.
    * @param xmtr_num    The transmitter number to use.
    * @param data_rate   The data measurement rate to use.
    *
    * @return  0 - The configuration was sent successfully.
    * @return -1 - The configuration could not be send to the server.
    */
    ...
    *
    * @return Non-NULL - A pointer to a BIRDNET::DATA_PACKET that the
    ...
    *
    * @return  0 - The server is now sending continuous data.
    * @return -1 - The run mode could not be set to BIRDNET::CONTINUOUS.
    */
    ...
    *
    * @param high_byte  The byte that will become the high byte of the
    *                    returned word.
    * @param low_byte   The byte that will become the low byte of the
    *                    returned word.
    *
    ...
    *
    * @param high_byte  The most significant byte of the raw data
    *                    representing a floating-point number.
    * @param low_byte   The least significant byte of the raw data
    *                    representing a floating-point number.
    *
    ...
    * @param str_rate  Storage for the string representation of the data
    *                   measurement rate.
    */
    ...
    * @param bird_status  The single bird status block being used to get the
    *                      unit information.
    */
    ...
    * @param packet_size  The size of the message being sent.
    *
    * @return  0 - The message was sent without error.
    * @return -1 - The message could not be sent to the server.  This is
    *                usually due to a system error.
    * @return -2 - Nothing was sent to the server.  This is likely to be
    ...
    * @param packet_size  The size of the given memory block.
    *
    * @return  0 - The response was received without error.
    * @return -1 - The response could not be read from the server.  This is
    *                usually due to a system error.
    * @return -2 - Nothing was read from the server.  This is likely to be
    ...
    *
    * @param status_info  A pointer to a BIRDNET::SYSTEM_STATUS object
    ...
    *
    * @param err_code  The single-byte error code.
    */
   ...
   unsigned int       m_birds_requested;  /**< Number of birds whose data will be read */

...
/**
 * Default implementation of the ConfigDefinitionRepositoryListener interface
 * that does nothing in order to make the creating of ConfigDefinitionRepository
 * listeners easier.
 */
public abstract class ConfigDefinitionRepositoryAdapter

...
import org.vrjuggler.jccl.config.ChunkDesc;
import org.vrjuggler.jccl.config.PropertyDesc;

/**
 * A property sheet for a chunk desc object.
 */
public class ChunkDescPropertySheet
   extends JTable
{
   public ChunkDescPropertySheet()
   {
      ...
      // Setup the table
      tableModel = new ChunkDescTableModel();
      setModel(tableModel);
...
//                           new ChunkDescPropertyValueRenderer());
   ...
   {
      tableModel.setChunkDesc(desc);
   }

   public ChunkDesc getChunkDesc()
   {
      return tableModel.getChunkDesc();
   }

   /**
    * The table model for the property sheet.
    */
   private ChunkDescTableModel tableModel;

 ...
 * PropertyDescs.
 */
public class PropertyDescEditorRegistry
{
   /**
    * Attempts to find a PropertyEditor that can edit property values described
    * by the PropertyDesc identified by the given token.
    *
    * @param token      the token of the PropertyDesc for which to get an editor
    *
    * @return  an editor object for the given PropertyDesc token; null if no
    *          suitable editor can be found
    */
    ...
    * the PropertyDesc identified by the given token.
    *
    * @param token         the token of the PropertyDesc describing the property
    *                      that will be edited
   ...
   /**
    * The map of PropertyDesc tokens to PropertyEditors.
    */

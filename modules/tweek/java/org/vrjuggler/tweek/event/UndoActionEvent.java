...
/**
 * Event generated by a Tweek Bean when an undo/redo event has taken place.
 *
...
{
   public UndoActionEvent(UndoHandler source)
   {
      super(source);
      undoHandler = source;
   }

   public UndoActionEvent(Object source, UndoHandler handler)
   {
      super(source);
      undoHandler = handler;
   }

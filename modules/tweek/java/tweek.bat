...
java -DTWEEK_BASE_DIR="%TWEEK_BASE_DIR%" -Djava.library.path="%TWEEK_BASE_DIR%\share\tweek\java" -Djava.security.policy="%TWEEK_BASE_DIR%\share\tweek\java\java.security.policy.txt" -cp "%TWEEK_CLASSPATH%" org.vrjuggler.tweek.Tweek %*
GOTO DONE
:ERREXIT

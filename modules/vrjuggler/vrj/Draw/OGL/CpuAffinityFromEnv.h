...
#ifndef _VRJ_OGL_CPU_AFFINITY_FROM_ENV_H_
#define _VRJ_OGL_CPU_AFFINITY_FROM_ENV_H_
 ...
 * @since 2.2.1
 */
class VJ_OGL_CLASS_API CpuAffinityFromEnv
{
public:
   /**
...
#endif /* _VRJ_OGL_CPU_AFFINITY_FROM_ENV_H_ */

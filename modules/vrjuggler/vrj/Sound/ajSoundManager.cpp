...
namespace vrj
{
   ...
   bool ajSoundManager::configAdd( ConfigChunk* chunk )
   {
   ...
   //! PRE: configCanHandle(chunk) == true
   bool ajSoundManager::configRemove(ConfigChunk* chunk)
   {
   ...
   bool ajSoundManager::configCanHandle( ConfigChunk* chunk )
   {

...
namespace vrj
{
   ...
   bool ajSoundManager::configAdd( jccl::ConfigChunk* chunk )
   {
   ...
   //! PRE: configCanHandle(chunk) == true
   bool ajSoundManager::configRemove(jccl::ConfigChunk* chunk)
   {
   ...
   bool ajSoundManager::configCanHandle( jccl::ConfigChunk* chunk )
   {

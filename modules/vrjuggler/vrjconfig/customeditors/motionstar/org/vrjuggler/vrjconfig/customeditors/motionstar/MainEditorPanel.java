...
*/
      ...
      throws Exception
   {
      ...
      mHelpScrollPanel.setPreferredSize(new Dimension(225, 680));
      mContentPanel.setMinimumSize(new Dimension(600, 680));
      mContentPanel.setPreferredSize(new Dimension(735, 680));

...
public class WallPanel extends JPanel implements EditorConstants
{
   ...
   private void jbInit() throws Exception
   {
      ...
      add(mWallEditorPanel, BorderLayout.CENTER);
   }
   ...
   public void init(Map whiteboard)
   {
      ...
      mCaveModel = (CaveModel) mWhiteBoard.get("CaveModel");

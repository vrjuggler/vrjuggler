...
Build targets are:
    ...
    debug           - Build the VPR libraries (dynamic and static) with
    ...
    ddso            - Build the debugging, dynamic shared object version of
                      the libraries.
    optim           - Build the VPR libraries (dynamic and static) with
...
Install targets are:
    ...
    install         - Install the full debugging version of VPR (with both
    ...
    install-ddso    - Install the debugging, dynamic shared object version of
                      the libraries.
    install-optim   - Install the full optimized version of VPR (with both
                      static and dynamic libraries).

...
gmtl_funcs.addFunction('gmtl::add')
gmtl_funcs.addFunction('gmtl::center')
gmtl_funcs.addFunction('gmtl::conj')
gmtl_funcs.addFunction('gmtl::cross')
gmtl_funcs.addFunction('gmtl::distance')
gmtl_funcs.addFunction('gmtl::distanceSquared')
gmtl_funcs.addFunction('gmtl::div')
gmtl_funcs.addFunction('gmtl::dot')
gmtl_funcs.addFunction('gmtl::exp')
gmtl_funcs.addFunction('gmtl::findNearestPt')
gmtl_funcs.addFunction('gmtl::identity')
gmtl_funcs.addFunction('gmtl::invert')
gmtl_funcs.addFunction('gmtl::invertAffine')
gmtl_funcs.addFunction('gmtl::invertFull')
gmtl_funcs.addFunction('gmtl::invertOrthogonal')
gmtl_funcs.addFunction('gmtl::invertTrans')
gmtl_funcs.addFunction('gmtl::isEqual')
gmtl_funcs.addFunction('gmtl::isEquiv')
gmtl_funcs.addFunction('gmtl::isNormalized')
gmtl_funcs.addFunction('gmtl::length')
gmtl_funcs.addFunction('gmtl::lengthSquared')
gmtl_funcs.addFunction('gmtl::lerp')
gmtl_funcs.addFunction('gmtl::log')
gmtl_funcs.addFunction('gmtl::mult')
gmtl_funcs.addFunction('gmtl::negate')
gmtl_funcs.addFunction('gmtl::postMult')
gmtl_funcs.addFunction('gmtl::preMult')
gmtl_funcs.addFunction('gmtl::reflect')
gmtl_funcs.addFunction('gmtl::slerp')
gmtl_funcs.addFunction('gmtl::squad')
gmtl_funcs.addFunction('gmtl::sub')
gmtl_funcs.addFunction('gmtl::transpose')
gmtl_funcs.addFunction('gmtl::whichSide')
gmtl_funcs.addFunction('gmtl::zero')

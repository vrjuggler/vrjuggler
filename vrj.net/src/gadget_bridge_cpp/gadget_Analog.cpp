...
extern "C"
{
   ...
   SHARPPY_API gadget::AnalogData* gadget_Analog_getAnalogData__int(gadget_Analog_Adapter* self_, int p0)
   {
   ...
   SHARPPY_API void gadget_Analog_swapAnalogBuffers__(gadget_Analog_Adapter* self_)
   {
      self_->swapAnalogBuffers();
   }

   // Wrapper for non-virtual method gadget::Analog::normalizeMinToMax()
   SHARPPY_API void gadget_Analog_normalizeMinToMax__float_float(gadget_Analog_Adapter* self_, const float& p0, float& p1)
   {
      self_->normalizeMinToMax(p0, p1);
   }

   // Wrapper for non-virtual method gadget::Analog::getMin()
   SHARPPY_API float gadget_Analog_getMin__(gadget_Analog_Adapter* self_)
   {
      float result;
      result = self_->getMin();
   ...
   SHARPPY_API float gadget_Analog_getMax__(gadget_Analog_Adapter* self_)
   {
      float result;
      result = self_->getMax();
   ...
   SHARPPY_API void gadget_Analog_setMin__float(gadget_Analog_Adapter* self_, float p0)
   {
      self_->setMin(p0);
   }

   // Wrapper for non-virtual method gadget::Analog::setMax()
   SHARPPY_API void gadget_Analog_setMax__float(gadget_Analog_Adapter* self_, float p0)
   {
      self_->setMax(p0);
   }
   ...
   SHARPPY_API vpr::ReturnStatus* gadget_Analog_writeObject__vpr_ObjectWriter(gadget_Analog_Adapter* self_, vpr::ObjectWriter* p0)
   {
   ...
   SHARPPY_API vpr::ReturnStatus* gadget_Analog_readObject__vpr_ObjectReader(gadget_Analog_Adapter* self_, vpr::ObjectReader* p0)
   {
      vpr::ReturnStatus* result;
   ...
   SHARPPY_API bool gadget_Analog_config__boost_shared_ptr_jccl__ConfigElement(gadget_Analog_Adapter* self_, boost::shared_ptr<jccl::ConfigElement> p0)
   {
      bool result;
   ...
   SHARPPY_API char* gadget_Analog_getBaseType__(gadget_Analog_Adapter* self_)
   {
      char* result;

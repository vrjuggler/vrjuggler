...
#ifndef __GADGET_ANALOGPROXY_ADAPTER__
#define __GADGET_ANALOGPROXY_ADAPTER__

#include "sharppy.h"
#include <gadget/Type/AnalogProxy.h>

class SHARPPY_API gadget_AnalogProxy_Adapter : public gadget::AnalogProxy
{
public:
   gadget_AnalogProxy_Adapter(const gadget::AnalogProxy& p0)
      : gadget::AnalogProxy(p0)
   {;}

   gadget_AnalogProxy_Adapter()
      : gadget::AnalogProxy()
   {;}

   virtual ~gadget_AnalogProxy_Adapter()
   {;}
   ...
   /// Override for virtual function gadget::AnalogProxy::updateData.
   ...
   /// Override for virtual function gadget::AnalogProxy::config.
   ...
   /// Override for virtual function gadget::AnalogProxy::getProxiedInputDevice.
   virtual gadget::Input* getProxiedInputDevice()
   {
      return getProxiedInputDevice_callback();
   }

}; // class gadget_AnalogProxy_Adapter

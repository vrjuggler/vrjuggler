...
public:
   ...
   struct holder_p0_gadget_Position_config__boost_shared_ptr_jccl__ConfigElement { boost::shared_ptr<jccl::ConfigElement> mPtr; };
   typedef bool (*config_callback_boost_shared_ptr_jccl__ConfigElement_t)(holder_p0_gadget_Position_config__boost_shared_ptr_jccl__ConfigElement*);
   ...
   {
      holder_p0_gadget_Position_config__boost_shared_ptr_jccl__ConfigElement* h_p0 = new holder_p0_gadget_Position_config__boost_shared_ptr_jccl__ConfigElement; h_p0->mPtr = p0;

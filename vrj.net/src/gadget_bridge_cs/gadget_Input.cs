   ...
   : vpr.SerializableObject
{
   ...
   [DllImport("gadget_bridge", CharSet = CharSet.Ansi)]
   private extern static string gadget_Input_getInstanceName__(IntPtr obj);

   public  string getInstanceName()
   {
      string result;
      result = gadget_Input_getInstanceName__(mRawObject);
      return result;
   }

   [DllImport("gadget_bridge", CharSet = CharSet.Ansi)]
   private extern static bool gadget_Input_isActive__(IntPtr obj);

   public  bool isActive()
   {
      bool result;
      result = gadget_Input_isActive__(mRawObject);
      return result;
   }
   ...
   [DllImport("gadget_bridge", CharSet = CharSet.Ansi)]
   private extern static bool gadget_Input_config__boost_shared_ptr_jccl__ConfigElement(IntPtr obj,
   ...
   {
      bool result;
      result = gadget_Input_config__boost_shared_ptr_jccl__ConfigElement(mRawObject, p0);
      return result;
   }
   ...
   [DllImport("gadget_bridge", CharSet = CharSet.Ansi)]
   private extern static string gadget_Input_getBaseType__(IntPtr obj);

   public virtual string getBaseType()
   {
      string result;
      result = gadget_Input_getBaseType__(mRawObject);
      return result;
   }
   ...
   private extern static vpr.ReturnStatus gadget_Input_writeObject__vpr_ObjectWriter(IntPtr obj,
   ...
   public virtual vpr.ReturnStatus writeObject(vpr.ObjectWriter p0)
   {
      ...
      result = gadget_Input_writeObject__vpr_ObjectWriter(mRawObject, p0);
   ...
   [return : MarshalAs(UnmanagedType.CustomMarshaler,
                       MarshalTypeRef = typeof(vpr.ReturnStatusMarshaler))]
   private extern static vpr.ReturnStatus gadget_Input_readObject__vpr_ObjectReader(IntPtr obj,
   ...
   public virtual vpr.ReturnStatus readObject(vpr.ObjectReader p0)
   {
      ...
      vpr.ReturnStatus result;
      result = gadget_Input_readObject__vpr_ObjectReader(mRawObject, p0);
   ...
   [DllImport("gadget_bridge", CharSet = CharSet.Ansi)]
   private extern static string gadget_Input_getElementType__();

   public static string getElementType()
   {
      string result;
      result = gadget_Input_getElementType__();
      return result;
   }
...
public class InputMarshaler : ICustomMarshaler
{
   private class DummyInput : gadget.Input
   {
      ...
      [DllImport("gadget_bridge", CharSet = CharSet.Ansi)]
      private extern static bool gadget_Input_sample__(IntPtr obj);

      public override bool sample()
      {
         bool result;
         result = gadget_Input_sample__(mRawObject);
         return result;
      }

      [DllImport("gadget_bridge", CharSet = CharSet.Ansi)]
      private extern static bool gadget_Input_startSampling__(IntPtr obj);

      public override bool startSampling()
      {
         bool result;
         result = gadget_Input_startSampling__(mRawObject);
         return result;
      }

      [DllImport("gadget_bridge", CharSet = CharSet.Ansi)]
      private extern static bool gadget_Input_stopSampling__(IntPtr obj);

      public override bool stopSampling()
      {
         bool result;
         result = gadget_Input_stopSampling__(mRawObject);
         return result;
      }

      [DllImport("gadget_bridge", CharSet = CharSet.Ansi)]
      private extern static void gadget_Input_updateData__(IntPtr obj);

      public override void updateData()
      {
         gadget_Input_updateData__(mRawObject);
      }

      [DllImport("gadget_bridge", CharSet = CharSet.Ansi)]
      private extern static void gadget_Input_destroy__(IntPtr obj);

      protected override void destroy()
      {
         gadget_Input_destroy__(mRawObject);
      }

   ...
   : gadget.Proxy
{
   ...
   private extern static IntPtr gadget_TypedProxy_gadget_Digital__TypedProxy__([MarshalAs(UnmanagedType.FunctionPtr)] refreshDelegate d0,
   ...
   {
      allocDelegates();
      mRawObject   = gadget_TypedProxy_gadget_Digital__TypedProxy__(m_refreshDelegate, m_getDeviceNameDelegate, m_configDelegate_boost_shared_ptr_jccl__ConfigElement, m_updateDataDelegate, m_getProxiedInputDeviceDelegate, m_isStupifiedDelegate);
      mWeOwnMemory = true;
   }
...
public class TypedProxy_gadget__DigitalMarshaler : ICustomMarshaler
{
   ...
   {
      return ((gadget.TypedProxy_gadget__Digital) obj).mRawObject;
   }

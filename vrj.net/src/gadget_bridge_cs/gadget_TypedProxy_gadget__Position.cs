   ...
   : gadget.Proxy
{
   ...
   private extern static IntPtr gadget_TypedProxy_gadget_Position__TypedProxy__([MarshalAs(UnmanagedType.FunctionPtr)] refreshDelegate d0,
   ...
   {
      allocDelegates();
      mRawObject   = gadget_TypedProxy_gadget_Position__TypedProxy__(m_refreshDelegate, m_getDeviceNameDelegate, m_configDelegate_boost_shared_ptr_jccl__ConfigElement, m_updateDataDelegate, m_getProxiedInputDeviceDelegate, m_isStupifiedDelegate);
      mWeOwnMemory = true;
   }
   ...
   [DllImport("gadget_bridge", CharSet = CharSet.Ansi)]
   private extern static bool gadget_TypedProxy_gadget_Position__refresh__(IntPtr obj);

   public override bool refresh()
   {
      bool result;
      result = gadget_TypedProxy_gadget_Position__refresh__(mRawObject);
      return result;
   }
   ...
   [DllImport("gadget_bridge", CharSet = CharSet.Ansi)]
   private extern static string gadget_TypedProxy_gadget_Position__getDeviceName__(IntPtr obj);

   public virtual string getDeviceName()
   {
      string result;
      result = gadget_TypedProxy_gadget_Position__getDeviceName__(mRawObject);
      return result;
   }

...
*/
   ...
   SHARPPY_API const gmtl::Vec3f* gmtl_Coord_gmtl_Vec_float_3__gmtl_EulerAngle_float_gmtl_ZXY____getPos__(gmtl::Coord3fZXY* self_)
   {
   ...
   SHARPPY_API const gmtl::EulerAngleZXYf* gmtl_Coord_gmtl_Vec_float_3__gmtl_EulerAngle_float_gmtl_ZXY____getRot__(gmtl::Coord3fZXY* self_)
   {
   ...
   SHARPPY_API gmtl::Vec3f* gmtl_Coord_gmtl_Vec_float_3__gmtl_EulerAngle_float_gmtl_ZXY____pos__(gmtl::Coord3fZXY* self_)
   {
      gmtl::Vec3f* result;
   ...
   SHARPPY_API gmtl::EulerAngleZXYf* gmtl_Coord_gmtl_Vec_float_3__gmtl_EulerAngle_float_gmtl_ZXY____rot__(gmtl::Coord3fZXY* self_)
   {

...
*/
   ...
   SHARPPY_API const gmtl::Vec4d* gmtl_Coord_gmtl_Vec_double_4__gmtl_EulerAngle_double_gmtl_ZXY____getPos__(gmtl::Coord4dZXY* self_)
   {
   ...
   SHARPPY_API const gmtl::EulerAngleZXYd* gmtl_Coord_gmtl_Vec_double_4__gmtl_EulerAngle_double_gmtl_ZXY____getRot__(gmtl::Coord4dZXY* self_)
   {
   ...
   SHARPPY_API gmtl::Vec4d* gmtl_Coord_gmtl_Vec_double_4__gmtl_EulerAngle_double_gmtl_ZXY____pos__(gmtl::Coord4dZXY* self_)
   {
      gmtl::Vec4d* result;
   ...
   SHARPPY_API gmtl::EulerAngleZXYd* gmtl_Coord_gmtl_Vec_double_4__gmtl_EulerAngle_double_gmtl_ZXY____rot__(gmtl::Coord4dZXY* self_)
   {

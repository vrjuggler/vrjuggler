...
*/
   ...
   SHARPPY_API const gmtl::Vec4f* gmtl_Coord_gmtl_Vec_float_4__gmtl_Quat_float____getPos__(gmtl::Coord4fQuat* self_)
   {
   ...
   SHARPPY_API const gmtl::Quatf* gmtl_Coord_gmtl_Vec_float_4__gmtl_Quat_float____getRot__(gmtl::Coord4fQuat* self_)
   {
   ...
   SHARPPY_API gmtl::Vec4f* gmtl_Coord_gmtl_Vec_float_4__gmtl_Quat_float____pos__(gmtl::Coord4fQuat* self_)
   {
      gmtl::Vec4f* result;
   ...
   SHARPPY_API gmtl::Quatf* gmtl_Coord_gmtl_Vec_float_4__gmtl_Quat_float____rot__(gmtl::Coord4fQuat* self_)
   {
      gmtl::Quatf* result;

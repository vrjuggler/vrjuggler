...
{
   // Constructor wrapper.
   SHARPPY_API gmtl::Coord4fZYX* gmtl_Coord_gmtl_Vec_float_4__gmtl_EulerAngle_float_gmtl_ZYX____Coord__()
   {
   ...
   // Constructor wrapper.
   SHARPPY_API gmtl::Coord4fZYX* gmtl_Coord_gmtl_Vec_float_4__gmtl_EulerAngle_float_gmtl_ZYX____Coord__gmtl_Coord4fZYX(const gmtl::Coord4fZYX* p0)
   {
   ...
   // Constructor wrapper.
   SHARPPY_API gmtl::Coord4fZYX* gmtl_Coord_gmtl_Vec_float_4__gmtl_EulerAngle_float_gmtl_ZYX____Coord__gmtl_Vec4f_gmtl_EulerAngleZYXf(const gmtl::Vec4f* p0, const gmtl::EulerAngleZYXf* p1)
   {
...
/*
   // Constructor wrapper.
   SHARPPY_API gmtl::Coord4fZYX* gmtl_Coord_gmtl_Vec_float_4__gmtl_EulerAngle_float_gmtl_ZYX____Coord__float_float_float_float_float_float(float p0, float p1, float p2, float p3, float p4, float p5)
   {
...
*/
   ...
   // Constructor wrapper.
   SHARPPY_API gmtl::Coord4fZYX* gmtl_Coord_gmtl_Vec_float_4__gmtl_EulerAngle_float_gmtl_ZYX____Coord__float_float_float_float_float_float_float(float p0, float p1, float p2, float p3, float p4, float p5, float p6)
   {
...
/*
   // Constructor wrapper.
   SHARPPY_API gmtl::Coord4fZYX* gmtl_Coord_gmtl_Vec_float_4__gmtl_EulerAngle_float_gmtl_ZYX____Coord__float_float_float_float_float_float_float_float(float p0, float p1, float p2, float p3, float p4, float p5, float p6, float p7)
   {

...
extern "C"
{
   ...
   SHARPPY_API void gmtl_Matrix_float_4_4__set__float_float_float_float(gmtl::Matrix44f* self_, float p0, float p1, float p2, float p3)
   {
      self_->set(p0, p1, p2, p3);
   }

   // Wrapper for non-virtual method gmtl::Matrix<float,4,4>::set()
   SHARPPY_API void gmtl_Matrix_float_4_4__set__float_float_float_float_float_float(gmtl::Matrix44f* self_, float p0, float p1, float p2, float p3, float p4, float p5)
   {
      self_->set(p0, p1, p2, p3, p4, p5);
   }

   // Wrapper for non-virtual method gmtl::Matrix<float,4,4>::set()
   SHARPPY_API void gmtl_Matrix_float_4_4__set__float_float_float_float_float_float_float_float_float(gmtl::Matrix44f* self_, float p0, float p1, float p2, float p3, float p4, float p5, float p6, float p7, float p8)
   {
      self_->set(p0, p1, p2, p3, p4, p5, p6, p7, p8);
   }

   // Wrapper for non-virtual method gmtl::Matrix<float,4,4>::set()
   SHARPPY_API void gmtl_Matrix_float_4_4__set__float_float_float_float_float_float_float_float_float_float_float_float(gmtl::Matrix44f* self_, float p0, float p1, float p2, float p3, float p4, float p5, float p6, float p7, float p8, float p9, float p10, float p11)
   {
      self_->set(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11);
   }

   // Wrapper for non-virtual method gmtl::Matrix<float,4,4>::set()
   SHARPPY_API void gmtl_Matrix_float_4_4__set__float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float(gmtl::Matrix44f* self_, float p0, float p1, float p2, float p3, float p4, float p5, float p6, float p7, float p8, float p9, float p10, float p11, float p12, float p13, float p14, float p15)
   {
      self_->set(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15);
   }

   // Wrapper for non-virtual method gmtl::Matrix<float,4,4>::set()
   SHARPPY_API void gmtl_Matrix_float_4_4__set__float(gmtl::Matrix44f* self_, const float* p0)
   {
      self_->set(p0);
   }

   // Wrapper for non-virtual method gmtl::Matrix<float,4,4>::setTranspose()
   SHARPPY_API void gmtl_Matrix_float_4_4__setTranspose__float(gmtl::Matrix44f* self_, const float* p0)
   {
      self_->setTranspose(p0);
   }

   // Wrapper for non-virtual method gmtl::Matrix<float,4,4>::getData()
   SHARPPY_API const float* gmtl_Matrix_float_4_4__getData__(gmtl::Matrix44f* self_)
   {
      const float* result;
   ...
   SHARPPY_API bool gmtl_Matrix_float_4_4__isError__(gmtl::Matrix44f* self_)
   {
      bool result;
   ...
   SHARPPY_API void gmtl_Matrix_float_4_4__setError__(gmtl::Matrix44f* self_)
   {
      self_->setError();
   }

...
extern "C"
{
   ...
   SHARPPY_API gmtl::Vec3f* gmtl_Tri_float__edge__int(gmtl::Trif* self_, int p0)
   {
      gmtl::Vec3f* result;
   ...
   // Wrapper for non-virtual method gmtl::Tri<float>::edge()
   SHARPPY_API gmtl::Vec3f* gmtl_Tri_float__edge__int_int(gmtl::Trif* self_, int p0, int p1)
   {
      gmtl::Vec3f* result;
   ...
   SHARPPY_API void gmtl_Tri_float__set__gmtl_Point3f_gmtl_Point3f_gmtl_Point3f(gmtl::Trif* self_, const gmtl::Point3f* p0, const gmtl::Point3f* p1, const gmtl::Point3f* p2)
   {
      const gmtl::Point3f& marshal_p0 = *p0; // Pre-call marshaling for p0
      const gmtl::Point3f& marshal_p1 = *p1; // Pre-call marshaling for p1
      const gmtl::Point3f& marshal_p2 = *p2; // Pre-call marshaling for p2

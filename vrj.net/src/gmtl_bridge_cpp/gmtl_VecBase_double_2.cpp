...
/*
   ...
   SHARPPY_API void gmtl_VecBase_double_2__set__double(gmtl::VecBase<double,2>* self_, const double* p0)
   {
      self_->set(p0);
   }
*/
   ...
   // Wrapper for non-virtual method gmtl::VecBase<double,2>::set()
   SHARPPY_API void gmtl_VecBase_double_2__set__double_double(gmtl::VecBase<double,2>* self_, const double& p0, const double& p1)
   {
      self_->set(p0, p1);
   }

   // Wrapper for non-virtual method gmtl::VecBase<double,2>::set()
   SHARPPY_API void gmtl_VecBase_double_2__set__double_double_double(gmtl::VecBase<double,2>* self_, const double& p0, const double& p1, const double& p2)
   {
      self_->set(p0, p1, p2);
   }

   // Wrapper for non-virtual method gmtl::VecBase<double,2>::set()
   SHARPPY_API void gmtl_VecBase_double_2__set__double_double_double_double(gmtl::VecBase<double,2>* self_, const double& p0, const double& p1, const double& p2, const double& p3)
   {
      self_->set(p0, p1, p2, p3);
   }

   // Wrapper for non-virtual method gmtl::VecBase<double,2>::getData()
   SHARPPY_API double* gmtl_VecBase_double_2__getData__(gmtl::VecBase<double,2>* self_)
   {
      double* result;
...
/*
   // Wrapper for non-virtual method gmtl::VecBase<double,2>::getData()
   SHARPPY_API const double* gmtl_VecBase_double_2__getData__(gmtl::VecBase<double,2>* self_)
   {
      const double* result;
      result = self_->getData();

...
{
   // Constructor wrapper.
   SHARPPY_API gmtl::VecBase<float,4>* gmtl_VecBase_float_4__VecBase__()
   {
   ...
   // Constructor wrapper.
   SHARPPY_API gmtl::VecBase<float,4>* gmtl_VecBase_float_4__VecBase__float_float(const float& p0, const float& p1)
   {
   ...
   // Constructor wrapper.
   SHARPPY_API gmtl::VecBase<float,4>* gmtl_VecBase_float_4__VecBase__float_float_float(const float& p0, const float& p1, const float& p2)
   {
   ...
   // Constructor wrapper.
   SHARPPY_API gmtl::VecBase<float,4>* gmtl_VecBase_float_4__VecBase__float_float_float_float(const float& p0, const float& p1, const float& p2, const float& p3)
   {
...
*/
   ...
   // Wrapper for non-virtual method gmtl::VecBase<float,4>::set()
   SHARPPY_API void gmtl_VecBase_float_4__set__float_float_float(gmtl::VecBase<float,4>* self_, const float& p0, const float& p1, const float& p2)
   {
      self_->set(p0, p1, p2);
   }

   // Wrapper for non-virtual method gmtl::VecBase<float,4>::set()
   SHARPPY_API void gmtl_VecBase_float_4__set__float_float_float_float(gmtl::VecBase<float,4>* self_, const float& p0, const float& p1, const float& p2, const float& p3)
   {
      self_->set(p0, p1, p2, p3);
   }

   // Wrapper for non-virtual method gmtl::VecBase<float,4>::getData()
   SHARPPY_API float* gmtl_VecBase_float_4__getData__(gmtl::VecBase<float,4>* self_)
   {
      float* result;
   ...
   // Wrapper for non-virtual method gmtl::VecBase<float,4>::getData()
/*
   SHARPPY_API const float* gmtl_VecBase_float_4__getData__(gmtl::VecBase<float,4>* self_)
   {
      const float* result;
      result = self_->getData();

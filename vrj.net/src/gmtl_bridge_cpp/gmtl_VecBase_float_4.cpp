...
*/
   ...
   SHARPPY_API float* gmtl_VecBase_float_4__getData__0(gmtl::VecBase<float,4>* self_)
   {
      float* result;
...
/*
   // Wrapper for non-virtual method gmtl::VecBase<float,4>::getData()
   SHARPPY_API const float* gmtl_VecBase_float_4__getData__0(gmtl::VecBase<float,4>* self_)
   {
      const float* result;
      result = self_->getData();
      return result;

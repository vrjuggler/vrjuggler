...
/*
   ...
   SHARPPY_API void gmtl_VecBase_int_3__set__int(gmtl::VecBase<int,3>* self_, const int* p0)
   {
      self_->set(p0);
   }
*/
   ...
   // Wrapper for non-virtual method gmtl::VecBase<int,3>::set()
   SHARPPY_API void gmtl_VecBase_int_3__set__int_int(gmtl::VecBase<int,3>* self_, const int& p0, const int& p1)
   {
      self_->set(p0, p1);
   }

   // Wrapper for non-virtual method gmtl::VecBase<int,3>::set()
   SHARPPY_API void gmtl_VecBase_int_3__set__int_int_int(gmtl::VecBase<int,3>* self_, const int& p0, const int& p1, const int& p2)
   {
      self_->set(p0, p1, p2);
   }

   // Wrapper for non-virtual method gmtl::VecBase<int,3>::set()
   SHARPPY_API void gmtl_VecBase_int_3__set__int_int_int_int(gmtl::VecBase<int,3>* self_, const int& p0, const int& p1, const int& p2, const int& p3)
   {
      self_->set(p0, p1, p2, p3);
   }

   // Wrapper for non-virtual method gmtl::VecBase<int,3>::getData()
   SHARPPY_API int* gmtl_VecBase_int_3__getData__(gmtl::VecBase<int,3>* self_)
   {
      int* result;
...
/*
   // Wrapper for non-virtual method gmtl::VecBase<int,3>::getData()
   SHARPPY_API const int* gmtl_VecBase_int_3__getData__(gmtl::VecBase<int,3>* self_)
   {
      const int* result;
      result = self_->getData();

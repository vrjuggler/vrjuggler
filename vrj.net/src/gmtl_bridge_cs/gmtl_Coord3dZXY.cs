...
public sealed class Coord3dZXY
{
   ...
   private extern static gmtl.Vec3d gmtl_Coord_gmtl_Vec_double_3__gmtl_EulerAngle_double_gmtl_ZXY____getPos__(IntPtr obj);

   public  gmtl.Vec3d getPos()
   {
      gmtl.Vec3d result;
      result = gmtl_Coord_gmtl_Vec_double_3__gmtl_EulerAngle_double_gmtl_ZXY____getPos__(mRawObject);
      return result;
   }
   ...
   private extern static gmtl.EulerAngleZXYd gmtl_Coord_gmtl_Vec_double_3__gmtl_EulerAngle_double_gmtl_ZXY____getRot__(IntPtr obj);

   public  gmtl.EulerAngleZXYd getRot()
   {
      gmtl.EulerAngleZXYd result;
      result = gmtl_Coord_gmtl_Vec_double_3__gmtl_EulerAngle_double_gmtl_ZXY____getRot__(mRawObject);
      return result;
   }
   ...
   [return : MarshalAs(UnmanagedType.CustomMarshaler,
                       MarshalTypeRef = typeof(gmtl.Vec3dMarshaler))]
   private extern static gmtl.Vec3d gmtl_Coord_gmtl_Vec_double_3__gmtl_EulerAngle_double_gmtl_ZXY____pos__(IntPtr obj);

   public  gmtl.Vec3d pos()
   {
      gmtl.Vec3d result;
      result = gmtl_Coord_gmtl_Vec_double_3__gmtl_EulerAngle_double_gmtl_ZXY____pos__(mRawObject);
      return result;
   }
   ...
   [return : MarshalAs(UnmanagedType.CustomMarshaler,
                       MarshalTypeRef = typeof(gmtl.EulerAngleZXYdMarshaler))]
   private extern static gmtl.EulerAngleZXYd gmtl_Coord_gmtl_Vec_double_3__gmtl_EulerAngle_double_gmtl_ZXY____rot__(IntPtr obj);

   public  gmtl.EulerAngleZXYd rot()
   {
      gmtl.EulerAngleZXYd result;
      result = gmtl_Coord_gmtl_Vec_double_3__gmtl_EulerAngle_double_gmtl_ZXY____rot__(mRawObject);
      return result;
   }

...
public sealed class Coord4dAxisAngle
{
   ...
   private extern static gmtl.Vec4d gmtl_Coord_gmtl_Vec_double_4__gmtl_AxisAngle_double____getPos__(IntPtr obj);

   public  gmtl.Vec4d getPos()
   {
      gmtl.Vec4d result;
      result = gmtl_Coord_gmtl_Vec_double_4__gmtl_AxisAngle_double____getPos__(mRawObject);
      return result;
   }
   ...
   private extern static gmtl.AxisAngled gmtl_Coord_gmtl_Vec_double_4__gmtl_AxisAngle_double____getRot__(IntPtr obj);

   public  gmtl.AxisAngled getRot()
   {
      gmtl.AxisAngled result;
      result = gmtl_Coord_gmtl_Vec_double_4__gmtl_AxisAngle_double____getRot__(mRawObject);
      return result;
   }
   ...
   [return : MarshalAs(UnmanagedType.CustomMarshaler,
                       MarshalTypeRef = typeof(gmtl.Vec4dMarshaler))]
   private extern static gmtl.Vec4d gmtl_Coord_gmtl_Vec_double_4__gmtl_AxisAngle_double____pos__(IntPtr obj);

   public  gmtl.Vec4d pos()
   {
      gmtl.Vec4d result;
      result = gmtl_Coord_gmtl_Vec_double_4__gmtl_AxisAngle_double____pos__(mRawObject);
      return result;
   }
   ...
   [return : MarshalAs(UnmanagedType.CustomMarshaler,
                       MarshalTypeRef = typeof(gmtl.AxisAngledMarshaler))]
   private extern static gmtl.AxisAngled gmtl_Coord_gmtl_Vec_double_4__gmtl_AxisAngle_double____rot__(IntPtr obj);

   public  gmtl.AxisAngled rot()
   {
      gmtl.AxisAngled result;
      result = gmtl_Coord_gmtl_Vec_double_4__gmtl_AxisAngle_double____rot__(mRawObject);
      return result;
   }

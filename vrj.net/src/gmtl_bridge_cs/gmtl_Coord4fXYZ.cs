...
public sealed class Coord4fXYZ
{
   ...
   // Constructors.
   protected Coord4fXYZ(NoInitTag doInit)
   {
   }

   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_Coord_gmtl_Vec_float_4__gmtl_EulerAngle_float_gmtl_XYZ____Coord__();

   public Coord4fXYZ()
   {
      mRawObject   = gmtl_Coord_gmtl_Vec_float_4__gmtl_EulerAngle_float_gmtl_XYZ____Coord__();
      mWeOwnMemory = true;
   }

   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_Coord_gmtl_Vec_float_4__gmtl_EulerAngle_float_gmtl_XYZ____Coord__gmtl_Coord4fXYZ([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(gmtl.Coord4fXYZMarshaler))] gmtl.Coord4fXYZ p0);

   public Coord4fXYZ(gmtl.Coord4fXYZ p0)
   {
      
      mRawObject   = gmtl_Coord_gmtl_Vec_float_4__gmtl_EulerAngle_float_gmtl_XYZ____Coord__gmtl_Coord4fXYZ(p0);
      mWeOwnMemory = true;
      
   }

   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_Coord_gmtl_Vec_float_4__gmtl_EulerAngle_float_gmtl_XYZ____Coord__gmtl_Vec4f_gmtl_EulerAngleXYZf([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(gmtl.Vec4fMarshaler))] gmtl.Vec4f p0,
   ...
   public Coord4fXYZ(gmtl.Vec4f p0, gmtl.EulerAngleXYZf p1)
   {
      ...
      mRawObject   = gmtl_Coord_gmtl_Vec_float_4__gmtl_EulerAngle_float_gmtl_XYZ____Coord__gmtl_Vec4f_gmtl_EulerAngleXYZf(p0, p1);
      mWeOwnMemory = true;
   ...
   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_Coord_gmtl_Vec_float_4__gmtl_EulerAngle_float_gmtl_XYZ____Coord__float_float_float_float_float_float(float p0,
	float p1,
	float p2,
	float p3,
	float p4,
   ...
   {
      mRawObject   = gmtl_Coord_gmtl_Vec_float_4__gmtl_EulerAngle_float_gmtl_XYZ____Coord__float_float_float_float_float_float(p0, p1, p2, p3, p4, p5);
      mWeOwnMemory = true;
   }

   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_Coord_gmtl_Vec_float_4__gmtl_EulerAngle_float_gmtl_XYZ____Coord__float_float_float_float_float_float_float(float p0,
	float p1,
	float p2,
	float p3,
	float p4,
   ...
   {
      mRawObject   = gmtl_Coord_gmtl_Vec_float_4__gmtl_EulerAngle_float_gmtl_XYZ____Coord__float_float_float_float_float_float_float(p0, p1, p2, p3, p4, p5, p6);
      mWeOwnMemory = true;
   }

   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_Coord_gmtl_Vec_float_4__gmtl_EulerAngle_float_gmtl_XYZ____Coord__float_float_float_float_float_float_float_float(float p0,
	float p1,
	float p2,
	float p3,
	float p4,
   ...
   {
      mRawObject   = gmtl_Coord_gmtl_Vec_float_4__gmtl_EulerAngle_float_gmtl_XYZ____Coord__float_float_float_float_float_float_float_float(p0, p1, p2, p3, p4, p5, p6, p7);
      mWeOwnMemory = true;
   }
...
public class Coord4fXYZMarshaler : ICustomMarshaler
{
   ...
   {
      return ((gmtl.Coord4fXYZ) obj).mRawObject;
   }

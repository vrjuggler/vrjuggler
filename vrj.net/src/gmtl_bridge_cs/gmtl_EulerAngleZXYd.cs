...
public sealed class EulerAngleZXYd
{
   ...
   {
      gmtl_EulerAngle_double_gmtl_ZXY__set__double_double_double3(mRawObject, ref p0, ref p1, ref p2);
   }


   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static double gmtl_EulerAngle_double_gmtl_ZXY__getData__0(IntPtr obj);

   public  double getData()
   {
      double result;
      result = gmtl_EulerAngle_double_gmtl_ZXY__getData__0(mRawObject);
      return result;
   }

...
public sealed class EulerAngleZXYf
{
   ...
   {
      gmtl_EulerAngle_float_gmtl_ZXY__set__float_float_float3(mRawObject, ref p0, ref p1, ref p2);
   }


   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static float gmtl_EulerAngle_float_gmtl_ZXY__getData__0(IntPtr obj);

   public  float getData()
   {
      float result;
      result = gmtl_EulerAngle_float_gmtl_ZXY__getData__0(mRawObject);
      return result;
   }

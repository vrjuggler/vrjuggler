...
public sealed class EulerAngleZYXf
{
   ...
   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static void gmtl_EulerAngle_float_gmtl_ZYX__set__float_float_float(IntPtr obj,
	ref float p0,
	ref float p1,
	ref float p2);
   ...
   public  void set(ref float p0, ref float p1, ref float p2)
   {
      ...
      gmtl_EulerAngle_float_gmtl_ZYX__set__float_float_float(mRawObject, ref p0, ref p1, ref p2);
   ...
   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static float gmtl_EulerAngle_float_gmtl_ZYX__getData__(IntPtr obj);

   public  float getData()
   {
      float result;
      result = gmtl_EulerAngle_float_gmtl_ZYX__getData__(mRawObject);
      return result;
   }

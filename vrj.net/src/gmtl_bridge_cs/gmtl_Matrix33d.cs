...
public sealed class Matrix33d
{
   ...
   // Constructors.
   protected Matrix33d(NoInitTag doInit)
   {
   }
   ...
   {
      gmtl_Matrix_double_3_3__set__double1(mRawObject, ref p0);
   }
   ...
   {
      gmtl_Matrix_double_3_3__setTranspose__double1(mRawObject, ref p0);
   }


   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static double gmtl_Matrix_double_3_3__getData__0(IntPtr obj);

   public  double getData()
   {
      double result;
      result = gmtl_Matrix_double_3_3__getData__0(mRawObject);
      return result;
   }
...
public class Matrix33dMarshaler : ICustomMarshaler
{
   ...
   public IntPtr MarshalManagedToNative(Object obj)
   {
      return ((gmtl.Matrix33d) obj).mRawObject;
   }

   ...
   : gmtl.VecBase_int_3
{
   ...
   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_Point_int_3__Point__int_int(int p0,
	int p1);

   public Point3i(int p0, int p1)
      : base(new NoInitTag())   // Do not initialize mRawObject in base class
   {
      mRawObject   = gmtl_Point_int_3__Point__int_int(p0, p1);
      mWeOwnMemory = true;
   }

   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_Point_int_3__Point__int_int_int(int p0,
	int p1,
	int p2);
   ...
   public Point3i(int p0, int p1, int p2)
      : base(new NoInitTag())   // Do not initialize mRawObject in base class
   {
      mRawObject   = gmtl_Point_int_3__Point__int_int_int(p0, p1, p2);
      mWeOwnMemory = true;
   }

   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_Point_int_3__Point__int_int_int_int(int p0,
	int p1,
	int p2,
	int p3);
   ...
   public Point3i(int p0, int p1, int p2, int p3)
      : base(new NoInitTag())   // Do not initialize mRawObject in base class
   {
      mRawObject   = gmtl_Point_int_3__Point__int_int_int_int(p0, p1, p2, p3);
      mWeOwnMemory = true;
   }

   ...
   : gmtl.VecBase_double_4
{
   ...
   private extern static IntPtr gmtl_Point_double_4__Point__();

   public Point4d()
      : base(new NoInitTag())   // Do not initialize mRawObject in base class
   {
      mRawObject   = gmtl_Point_double_4__Point__();
      mWeOwnMemory = true;
   }

   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_Point_double_4__Point__gmtl_Point4d([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(gmtl.Point4dMarshaler))] gmtl.Point4d p0);

   public Point4d(gmtl.Point4d p0)
      : base(new NoInitTag())   // Do not initialize mRawObject in base class
   {
      
      mRawObject   = gmtl_Point_double_4__Point__gmtl_Point4d(p0);
      mWeOwnMemory = true;
      
   }

   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_Point_double_4__Point__gmtl_VecBase_double_4([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(gmtl.VecBase_double_4Marshaler))] gmtl.VecBase_double_4 p0);

   public Point4d(gmtl.VecBase_double_4 p0)
      : base(new NoInitTag())   // Do not initialize mRawObject in base class
   {
      
      mRawObject   = gmtl_Point_double_4__Point__gmtl_VecBase_double_4(p0);
      mWeOwnMemory = true;

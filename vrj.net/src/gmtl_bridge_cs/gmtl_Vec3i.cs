   ...
   : gmtl.VecBase_int_3
{
   ...
   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_Vec_int_3__Vec__int_int(ref int p0,
	ref int p1);

   public Vec3i(ref int p0, ref int p1)
      : base(new NoInitTag())   // Do not initialize mRawObject in base class
   {
      
      
      mRawObject   = gmtl_Vec_int_3__Vec__int_int(ref p0, ref p1);
      mWeOwnMemory = true;
   ...
   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_Vec_int_3__Vec__int_int_int(ref int p0,
	ref int p1,
	ref int p2);

   public Vec3i(ref int p0, ref int p1, ref int p2)
      : base(new NoInitTag())   // Do not initialize mRawObject in base class
   {
      
      
      
      mRawObject   = gmtl_Vec_int_3__Vec__int_int_int(ref p0, ref p1, ref p2);
      mWeOwnMemory = true;
   ...
   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_Vec_int_3__Vec__int_int_int_int(ref int p0,
	ref int p1,
	ref int p2,
	ref int p3);

   public Vec3i(ref int p0, ref int p1, ref int p2, ref int p3)
      : base(new NoInitTag())   // Do not initialize mRawObject in base class
   {
      ...
      mRawObject   = gmtl_Vec_int_3__Vec__int_int_int_int(ref p0, ref p1, ref p2, ref p3);
      mWeOwnMemory = true;

   ...
   : gmtl.VecBase_float_4
{
   ...
   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_Vec_float_4__Vec__float_float(ref float p0,
	ref float p1);

   public Vec4f(ref float p0, ref float p1)
      : base(new NoInitTag())   // Do not initialize mRawObject in base class
   {
      
      
      mRawObject   = gmtl_Vec_float_4__Vec__float_float(ref p0, ref p1);
      mWeOwnMemory = true;
   ...
   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_Vec_float_4__Vec__float_float_float(ref float p0,
	ref float p1,
	ref float p2);

   public Vec4f(ref float p0, ref float p1, ref float p2)
      : base(new NoInitTag())   // Do not initialize mRawObject in base class
   {
      
      
      
      mRawObject   = gmtl_Vec_float_4__Vec__float_float_float(ref p0, ref p1, ref p2);
      mWeOwnMemory = true;
   ...
   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_Vec_float_4__Vec__float_float_float_float(ref float p0,
	ref float p1,
	ref float p2,
	ref float p3);

   public Vec4f(ref float p0, ref float p1, ref float p2, ref float p3)
      : base(new NoInitTag())   // Do not initialize mRawObject in base class
   {
      ...
      mRawObject   = gmtl_Vec_float_4__Vec__float_float_float_float(ref p0, ref p1, ref p2, ref p3);
      mWeOwnMemory = true;

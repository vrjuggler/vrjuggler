...
public class VecBase_double_2
{
   ...
   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_VecBase_double_2__VecBase__double_double_double3(double p0, double p1, double p2);

   public VecBase_double_2(double p0, double p1, double p2)
   {
      mRawObject   = gmtl_VecBase_double_2__VecBase__double_double_double3(p0, p1, p2);
      mWeOwnMemory = true;
   }

   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_VecBase_double_2__VecBase__double_double_double_double4(double p0, double p1, double p2, double p3);

   public VecBase_double_2(double p0, double p1, double p2, double p3)
   {
      mRawObject   = gmtl_VecBase_double_2__VecBase__double_double_double_double4(p0, p1, p2, p3);
      mWeOwnMemory = true;
   }

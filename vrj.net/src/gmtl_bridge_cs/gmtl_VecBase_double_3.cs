...
public class VecBase_double_3
{
   ...
   {
      gmtl_VecBase_double_3__set__double1(mRawObject, ref p0);
   }
...
*/
   ...
   {
      gmtl_VecBase_double_3__set__double_double2(mRawObject, ref p0, ref p1);
   }
   ...
   {
      gmtl_VecBase_double_3__set__double_double_double3(mRawObject, ref p0, ref p1, ref p2);
   }
   ...
   {
      gmtl_VecBase_double_3__set__double_double_double_double4(mRawObject, ref p0, ref p1, ref p2, ref p3);
   }

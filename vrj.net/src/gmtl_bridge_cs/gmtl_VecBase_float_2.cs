...
public class VecBase_float_2
{
   ...
   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_VecBase_float_2__VecBase__float_float(float p0,
	float p1);

   public VecBase_float_2(float p0, float p1)
   {
      mRawObject   = gmtl_VecBase_float_2__VecBase__float_float(p0, p1);
      mWeOwnMemory = true;
   }

   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_VecBase_float_2__VecBase__float_float_float(float p0,
	float p1,
	float p2);

   public VecBase_float_2(float p0, float p1, float p2)
   {
      mRawObject   = gmtl_VecBase_float_2__VecBase__float_float_float(p0, p1, p2);
      mWeOwnMemory = true;
   }

   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_VecBase_float_2__VecBase__float_float_float_float(float p0,
	float p1,
	float p2,
	float p3);
   ...
   {
      mRawObject   = gmtl_VecBase_float_2__VecBase__float_float_float_float(p0, p1, p2, p3);
      mWeOwnMemory = true;
   }

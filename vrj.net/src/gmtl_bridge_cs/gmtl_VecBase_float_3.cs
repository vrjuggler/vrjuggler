...
public class VecBase_float_3
{
   ...
   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static void gmtl_VecBase_float_3__set__float(IntPtr obj,
	ref float p0);

   public  void set(ref float p0)
   {
      
      gmtl_VecBase_float_3__set__float(mRawObject, ref p0);
...
*/
   ...
   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static void gmtl_VecBase_float_3__set__float_float(IntPtr obj,
	ref float p0,
	ref float p1);
   ...
   public  void set(ref float p0, ref float p1)
   {
      ...
      gmtl_VecBase_float_3__set__float_float(mRawObject, ref p0, ref p1);
      
      
   }

   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static void gmtl_VecBase_float_3__set__float_float_float(IntPtr obj,
	ref float p0,
	ref float p1,
	ref float p2);
   ...
   public  void set(ref float p0, ref float p1, ref float p2)
   {
      ...
      gmtl_VecBase_float_3__set__float_float_float(mRawObject, ref p0, ref p1, ref p2);
   ...
   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static void gmtl_VecBase_float_3__set__float_float_float_float(IntPtr obj,
	ref float p0,
	ref float p1,
	ref float p2,
	ref float p3);
   ...
   public  void set(ref float p0, ref float p1, ref float p2, ref float p3)
   {
      ...
      gmtl_VecBase_float_3__set__float_float_float_float(mRawObject, ref p0, ref p1, ref p2, ref p3);
   ...
   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static float gmtl_VecBase_float_3__getData__(IntPtr obj);

   public  float getData()
   {
      float result;
      result = gmtl_VecBase_float_3__getData__(mRawObject);
      return result;
   }

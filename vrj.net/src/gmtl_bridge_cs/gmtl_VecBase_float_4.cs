...
public class VecBase_float_4
{
   ...
   {
      gmtl_VecBase_float_4__set__float1(mRawObject, ref p0);
   }
...
*/
   ...
   {
      gmtl_VecBase_float_4__set__float_float2(mRawObject, ref p0, ref p1);
   }
   ...
   {
      gmtl_VecBase_float_4__set__float_float_float3(mRawObject, ref p0, ref p1, ref p2);
   }
   ...
   {
      gmtl_VecBase_float_4__set__float_float_float_float4(mRawObject, ref p0, ref p1, ref p2, ref p3);
   }

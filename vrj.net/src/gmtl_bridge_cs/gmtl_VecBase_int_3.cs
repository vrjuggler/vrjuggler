...
public class VecBase_int_3
{
   ...
   {
      gmtl_VecBase_int_3__set__int1(mRawObject, ref p0);
   }
...
*/
   ...
   {
      gmtl_VecBase_int_3__set__int_int2(mRawObject, ref p0, ref p1);
   }
   ...
   {
      gmtl_VecBase_int_3__set__int_int_int3(mRawObject, ref p0, ref p1, ref p2);
   }
   ...
   {
      gmtl_VecBase_int_3__set__int_int_int_int4(mRawObject, ref p0, ref p1, ref p2, ref p3);
   }


   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static int gmtl_VecBase_int_3__getData__0(IntPtr obj);

   public  int getData()
   {
      int result;
      result = gmtl_VecBase_int_3__getData__0(mRawObject);
      return result;
   }

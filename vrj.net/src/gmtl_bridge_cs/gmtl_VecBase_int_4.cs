...
public class VecBase_int_4
{
   ...
   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_VecBase_int_4__VecBase__int_int(int p0,
	int p1);

   public VecBase_int_4(int p0, int p1)
   {
      mRawObject   = gmtl_VecBase_int_4__VecBase__int_int(p0, p1);
      mWeOwnMemory = true;
   }

   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_VecBase_int_4__VecBase__int_int_int(int p0,
	int p1,
	int p2);

   public VecBase_int_4(int p0, int p1, int p2)
   {
      mRawObject   = gmtl_VecBase_int_4__VecBase__int_int_int(p0, p1, p2);
      mWeOwnMemory = true;
   }

   [DllImport("gmtl_bridge", CharSet = CharSet.Ansi)]
   private extern static IntPtr gmtl_VecBase_int_4__VecBase__int_int_int_int(int p0,
	int p1,
	int p2,
	int p3);
   ...
   {
      mRawObject   = gmtl_VecBase_int_4__VecBase__int_int_int_int(p0, p1, p2, p3);
      mWeOwnMemory = true;
   }

   ...
   : jccl.ConfigElementHandler
{
   ...
   {
      allocDelegates();
      mRawObject   = vrj_SoundManager_SoundManager__0(m_configAddDelegate_boost_shared_ptr_jccl__ConfigElement, m_configRemoveDelegate_boost_shared_ptr_jccl__ConfigElement, m_configCanHandleDelegate_boost_shared_ptr_jccl__ConfigElement, m_updateDelegate, m_syncDelegate, m_configProcessPendingDelegate);
      mWeOwnMemory = true;
   }
